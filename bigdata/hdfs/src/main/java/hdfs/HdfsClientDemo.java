...
public class HdfsClientDemo {
    ...
    public void init() throws Exception {
        ...
        //conf.set("fs.defaultFS", "hdfs://wj1:9000");

        //拿到一个文件系统操作的客户端实例对象
        fs = FileSystem.get(conf);
        //可以直接传入 uri和用户身份
        //fs = FileSystem.get(new URI("hdfs://wj1:9000"),conf,"hadoop"); //最后一个参数为用户名
    }
    ...
    public void testUpload() throws Exception {
        ...
        Thread.sleep(2000);
        fs.copyFromLocalFile(new Path("G:/dd.txt"), new Path("/log_network3.txt"));
        fs.close();
    }
